                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-outline-success btn-sm edit m-1" title="Restore" href="{{route('admin.blog.restore', $value->id)}}">
                                        <i class="fas fa-redo"></i>
                                    </a>
                                    <a class="btn btn-outline-danger btn-sm edit m-1" title="Edit" href="{{route('admin.blog.forcedelete', $value->id)}}">
