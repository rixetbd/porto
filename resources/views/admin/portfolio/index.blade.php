...
<div class="row">
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header"><h6>All Porject <span class="float-end"><a href="{{route('admin.portfolio.new')}}" class="btn btn-sm btn-success">Add New</a></span></h6></div>
            <div class="card-body">
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($value->status == 1)
                                        <a class="btn status_btn" href="{{route('admin.portfolio.status', $value->id)}}">
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-outline-danger btn-sm edit m-1" title="Delete" href="{{route('admin.portfolio.softdelete', $value->id)}}">
